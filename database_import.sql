--=====================================================
-- Referral Management System - Complete Database Import
--=====================================================
-- This file contains all tables, demo data, and configurations
...
--=====================================================
-- Insert Demo Users
INSERT INTO users (email, name, role, status, permissions, department, location, student_name, student_grade, referrals_count, conversions_count, earnings, last_login_at)
VALUES
-- Admin Users
('admin@example.com', 'Admin User', 'admin', 'active', '["users:read","users:write","forms:read","forms:write","analytics:read","analytics:write","settings:read","settings:write"]', 'Administration', 'Head Office', NULL, NULL, 0, 0, 0.00, '2024-01-21T17:30:00'),

-- Manager Users
('manager@example.com', 'Manager User', 'manager', 'active', '["users:read","forms:read","forms:write","analytics:read"]', 'Operations', 'Regional Office', NULL, NULL, 0, 0, 0.00, '2024-01-21T16:15:00'),
('sarah.johnson@company.com', 'Sarah Johnson', 'manager', 'active', '["users:read","forms:read","forms:write","analytics:read"]', 'Operations', 'Los Angeles, CA', NULL, NULL, 0, 0, 0.00, '2024-01-19T14:45:00'),

-- Staff Users
('john.smith@company.com', 'John Smith', 'staff', 'active', '["users:read","forms:read","forms:write","analytics:read","settings:read","settings:write"]', 'Administration', 'New York, NY', NULL, NULL, 0, 0, 0.00, '2024-01-20T10:30:00'),
('mike.chen@company.com', 'Mike Chen', 'staff', 'active', '["users:read","forms:read"]', 'Support', 'Austin, TX', NULL, NULL, 0, 0, 0.00, '2024-01-18T09:15:00'),
('emily.davis@company.com', 'Emily Davis', 'staff', 'inactive', '["forms:read","analytics:read"]', 'Marketing', 'Miami, FL', NULL, NULL, 0, 0, 0.00, '2024-01-15T16:20:00'),

-- Regular Users (Parents/Referrers)
('user@example.com', 'Regular User', 'user', 'active', '["forms:read"]', 'Parent', 'Los Angeles, CA', 'Student Name', '11th Grade', 8, 5, 250.00, '2024-01-20T12:00:00'),
('jennifer.smith@email.com', 'Jennifer Smith', 'user', 'active', '["forms:read"]', 'Parent', 'Los Angeles, CA', 'Emma Smith', '11th Grade', 8, 5, 250.00, '2024-01-20T10:15:00'),
('michael.chen@email.com', 'Michael Chen', 'user', 'active', '["forms:read"]', 'Educator', 'San Francisco, CA', 'David Chen', '12th Grade', 15, 12, 600.00, '2024-01-21T14:45:00'),
('lisa.rodriguez@email.com', 'Lisa Rodriguez', 'user', 'active', '["forms:read"]', 'Parent', 'Austin, TX', 'Carlos Rodriguez', '10th Grade', 3, 1, 50.00, '2024-01-18T09:15:00'),
('james.wilson@email.com', 'James Wilson', 'user', 'active', '["forms:read"]', 'Counselor', 'Boston, MA', 'Multiple Students', 'Various', 22, 18, 900.00, '2024-01-21T16:20:00'),
('robert.brown@email.com', 'Robert Brown', 'user', 'active', '["forms:read"]', 'Parent', 'Chicago, IL', 'Jessica Brown', '11th Grade', 12, 8, 400.00, '2024-01-19T11:30:00'),
('maria.garcia@email.com', 'Maria Garcia', 'user', 'active', '["forms:read"]', 'Parent', 'Phoenix, AZ', 'Diego Garcia', '12th Grade', 6, 4, 200.00, '2024-01-17T15:45:00'),
('david.lee@email.com', 'David Lee', 'user', 'active', '["forms:read"]', 'Educator', 'Seattle, WA', 'Multiple Students', 'Various', 18, 14, 700.00, '2024-01-20T13:20:00'),
('amy.taylor@email.com', 'Amy Taylor', 'user', 'inactive', '["forms:read"]', 'Parent', 'Denver, CO', 'Ryan Taylor', '10th Grade', 2, 0, 0.00, '2024-01-15T10:10:00');

-- Insert Demo Referral Links
INSERT INTO referral_links (affiliate_id, user_id, clicks, conversions, last_used_at, created_at)
VALUES
('demo123abc', 8, 25, 5, '2024-01-20T15:30:00', '2024-01-10T10:00:00'),
('sample456def', 9, 18, 3, '2024-01-19T11:45:00', '2024-01-12T14:30:00'),
('ref789ghi', 10, 32, 8, '2024-01-21T09:15:00', '2024-01-08T16:20:00'),
('test101jkl', 11, 15, 2, '2024-01-18T14:20:00', '2024-01-15T11:10:00'),
('link202mno', 12, 28, 6, '2024-01-20T16:45:00', '2024-01-05T13:45:00'),
('code303pqr', 13, 22, 4, '2024-01-19T12:30:00', '2024-01-14T09:30:00'),
('track404stu', 14, 35, 9, '2024-01-21T10:20:00', '2024-01-07T15:15:00'),
('share505vwx', 15, 12, 1, '2024-01-17T08:40:00', '2024-01-16T12:20:00');
...
(4, 'Educational Program Application', 'Daniel Martinez', 'daniel.martinez@email.com', '(555) 890-1234', 'Sofia Martinez', '11th Grade', 'sofia.martinez@student.edu', '(555) 890-1235', 'Kennedy High School', 'Northern School District', 'Boston', 'MA', 'SAT Prep', 'Robert Brown', 'test101jkl', 'pending', 'Scheduling initial assessment', '2024-01-19T08:30:00'),
(5, 'Educational Program Application', 'Linda Thompson', 'linda.thompson@email.com', '(555) 901-2345', 'Matthew Thompson', '12th Grade', 'matthew.thompson@student.edu', '(555) 901-2346', 'Central High School', 'Metro School District', 'Chicago', 'IL', 'ACT Prep', 'Maria Garcia', 'link202mno', 'enrolled', 'Student transferred from SAT to ACT prep', '2024-01-16T15:20:00'),
(6, 'Educational Program Application', 'Richard White', 'richard.white@email.com', '(555) 012-3456', 'Ashley White', '11th Grade', 'ashley.white@student.edu', '(555) 012-3457', 'Phoenix High School', 'Desert School District', 'Phoenix', 'AZ', 'AP Science', 'David Lee', 'code303pqr', 'contacted', 'Student excels in science, looking for advanced prep', '2024-01-20T12:10:00'),
(7, 'Educational Program Application', 'Michelle Clark', 'michelle.clark@email.com', '(555) 123-5678', 'Brandon Clark', '12th Grade', 'brandon.clark@student.edu', '(555) 123-5679', 'Seattle High School', 'Pacific School District', 'Seattle', 'WA', 'College Essays', 'Amy Taylor', 'track404stu', 'completed', 'Student submitted excellent college applications', '2024-01-18T14:25:00'),
(8, 'Educational Program Application', 'Kevin Lewis', 'kevin.lewis@email.com', '(555) 234-6789', 'Taylor Lewis', '10th Grade', 'taylor.lewis@student.edu', '(555) 234-6790', 'Mountain View High', 'Rocky Mountain District', 'Denver', 'CO', 'PSAT Prep', 'Jennifer Smith', 'share505vwx', 'pending', 'Parent requesting information about program schedule', '2024-01-21T11:40:00');
